...
gmx grompp -f ../../mdp-files/em.mdp -c ../../MPro-Wild-Nirmatrelvir.gro -r ../../MPro-Wild-Nirmatrelvir.gro -p ../../topol.top -o em.tpr  -maxwarn 5
...
srun --nodes=1 --ntasks=16 --cpus-per-task=1 --exact --mem=24000M gmx_mpi mdrun -s md$i.tpr -c mpro-md$i.gro &
